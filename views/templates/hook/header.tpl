{*
* 2017 - ? PaulD.codes
* added type="text/javascript" for CloudFlare Rocket loader
* local caching of fbevents.js
*
...
s.parentNode.insertBefore(t,s)}(window, document,'script', '{/literal}{$location|escape:'htmlall':'UTF-8'}{literal}');
...
{literal}
<script type="text/javascript">
fbq('{/literal}{$track|escape:'htmlall':'UTF-8'}{literal}', '{/literal}{if !empty($type)}{$type|escape:'htmlall':'UTF-8'}{/if}{literal}'{/literal}{if !empty($type) && empty($content)}, {$content nofilter}{/if}{literal});
</script>
{/literal}
{/if}