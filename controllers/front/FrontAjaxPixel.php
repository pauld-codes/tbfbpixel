...
class TbFbPixelFrontAjaxPixelModuleFrontcontroller extends ModuleFrontController
{

    //Redirect to home if trying to access to the front controller without ajax call
    public function initContent()
    {
        $this->module = Module::getInstanceByName('tbfbpixel');
    ...
    {
        if (empty(Configuration::get('TB_FB_PIXEL'))) {
            return;
        }
        ...
        $products = Product::getProductProperties($id_lang, $product, $this->context);
